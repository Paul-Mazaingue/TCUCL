  ...
  private categories : categories[] = [
    {
      ...
      posts: [
        {
          name: 'Intensité carbone de l\'électricité',
          color: '#2ecc71',
          value: 35,
          currentEmission: 120,
          reduction: 780,
        ...
        {
          name: 'Mode de répartition des émissions',
          color: '#f39c12',
          value: 100,
          currentEmission: 500,
          reduction: 0,
        ...
        {
          name: 'Exploitations agricoles exemplaires',
          color: '#16a085',
          value: 100,
          currentEmission: 180,
          reduction: 0,
        ...
        {
          name: 'Biens informatiques et Hifi',
          color: '#8e44ad',
          value: 100,
          currentEmission: 150,
          reduction: 0,
        ...
        {
          name: 'Autres biens manufacturés',
          color: '#9b59b6',
          value: 100,
          currentEmission: 200,
          reduction: 0,
        ...
        {
          name: 'Remplacement des véhicules particuliers',
          color: '#c0392b',
          value: 100,
          currentEmission: 250,
          reduction: 0,
        ...
        {
          name: 'Nombre de passagers par véhicule',
          color: '#e67e22',
          value: 100,
          currentEmission: 120,
          reduction: 0,
        ...
        {
          name: 'Marchandises transportées',
          color: '#f1c40f',
          value: 100,
          currentEmission: 350,
          reduction: 0,
